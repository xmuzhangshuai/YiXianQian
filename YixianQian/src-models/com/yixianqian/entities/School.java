...
public class School {
    ...
    private List<TodayRecommend> recommendList;
    ...
    public List<TodayRecommend> getRecommendList() {
        if (recommendList == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            TodayRecommendDao targetDao = daoSession.getTodayRecommendDao();
            List<TodayRecommend> recommendListNew = targetDao._querySchool_RecommendList(id);
            synchronized (this) {
                if(recommendList == null) {
                    recommendList = recommendListNew;
                }
            }
        }
    ...
    public synchronized void resetRecommendList() {
        recommendList = null;
    }
